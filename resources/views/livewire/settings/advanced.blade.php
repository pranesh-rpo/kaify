    ...
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            <form wire:submit='submit' class="flex flex-col w-full">
                ...
                <div class="pb-4">Advanced settings for your Kaify instance.</div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_api_enabled" label="API Access"
                            helper="If enabled, authenticated requests to Kaify's REST API will be allowed. Configure API tokens in Security > API Tokens." />
                    </div>
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_sponsorship_popup_enabled" label="Show Sponsorship Popup"
                            helper="Show monthly sponsorship reminders to support Kaify development. Disable to hide these messages permanently." />
                    </div>
                </div>
                <div class="flex flex-col gap-1">
