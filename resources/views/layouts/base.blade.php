...
<head>
    ...
    <meta name="Description" content="Kaify: An open-source & self-hostable Docker management platform - Heroku / Netlify / Vercel alternative" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@kaifyio" />
    <meta name="twitter:title" content="Kaify" />
    <meta name="twitter:description" content="An open-source & self-hostable Docker management platform." />
    <meta name="twitter:image" content="https://cdn.kaify.io/assets/kaify/og-image.png" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://kaify.io" />
    <meta property="og:title" content="Kaify" />
    <meta property="og:description" content="An open-source & self-hostable Docker management platform." />
    <meta property="og:site_name" content="Kaify" />
    <meta property="og:image" content="https://cdn.kaify.io/assets/kaify/og-image.png" />
    ...
    @endphp
    <title>{{ $name }}{{ $title ?? 'Kaify' }}</title>
    @env('local')
        <link rel="icon" href="{{ asset('kaify-logo-dev-transparent.png') }}" type="image/png" />
    @else
        <link rel="icon" href="{{ asset('kaify-logo.svg') }}" type="image/svg+xml" />
    @endenv
    ...
    @if (config('app.name') == 'Kaify Cloud')
        <script defer data-domain="app.kaify.io" src="https://analytics.kaify.io/js/plausible.js"></script>
    ...
    <script data-navigate-once>
        ...
        @auth
            ...
            window.Echo = new Echo({
                ...
                key: "{{ config('constants.pusher.app_key') }}" || 'kaify',
