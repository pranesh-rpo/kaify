...
return [
    'kaify' => [
        ...
        'realtime_version' => '1.0.0',
        'self_hosted' => env('SELF_HOSTED', true),
        'autoupdate' => env('AUTOUPDATE'),
        'base_config_path' => env('BASE_CONFIG_PATH', '/data/kaify'),
        'registry_url' => env('REGISTRY_URL', 'ghcr.io'),
        'helper_image' => env('HELPER_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/pranesh-rpo/kaify-helper'),
        'realtime_image' => env('REALTIME_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/pranesh-rpo/kaify-realtime'),
        'is_windows_docker_desktop' => env('IS_WINDOWS_DOCKER_DESKTOP', false),
        'cdn_url' => env('CDN_URL', 'https://raw.githubusercontent.com/pranesh-rpo/kaify/main'),
        'versions_url' => env('VERSIONS_URL', env('CDN_URL', 'https://raw.githubusercontent.com/pranesh-rpo/kaify/main').'/versions.json'),
        'upgrade_script_url' => env('UPGRADE_SCRIPT_URL', env('CDN_URL', 'https://raw.githubusercontent.com/pranesh-rpo/kaify/main').'/scripts/upgrade.sh'),
        'releases_url' => 'https://raw.githubusercontent.com/pranesh-rpo/kaify/main/releases.json',
    ],

    'urls' => [
        'docs' => 'https://kaify.io/docs',
        'contact' => 'https://kaify.io/docs/contact',
    ],

    'services' => [
        'official' => 'https://raw.githubusercontent.com/pranesh-rpo/kaify/main/templates/service-templates-latest.json',
