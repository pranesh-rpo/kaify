...
class Server extends BaseModel
{
    ...
    protected function isKaifyHost(): Attribute
    {
    ...
    {
        $banner =
            "# This file is generated by Kaify, do not edit it manually.\n".
    ...
    public function setupDynamicProxyConfiguration()
    {
        ...
        if ($this->proxyType() === ProxyTypes::TRAEFIK->value) {
            ...
            if (empty($settings->fqdn) || (isCloud() && $this->id !== 0) || ! $this->isLocalhost()) {
                ...
                $yaml =
                    "# This file is automatically generated by Kaify.\n".
...
$schema://$host {
    ...
    {
        $base_path = config('constants.kaify.base_config_path');
    ...
    public function validateDockerEngine($throwError = false)
    {
        ...
        $this->settings->save();
        $this->validateKaifyNetwork(isSwarm: false, isBuildServer: $this->settings->is_build_server);
    ...
    public function validateDockerSwarm()
    {
        ...
        $this->settings->is_usable = true;
        $this->settings->save();
        $this->validateKaifyNetwork(isSwarm: true);
    ...
    public function validateKaifyNetwork($isSwarm = false, $isBuildServer = false)
    {
        if ($isBuildServer) {
            return;
        }
