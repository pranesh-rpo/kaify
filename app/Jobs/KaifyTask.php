...
use App\Actions\KaifyTask\RunRemoteProcess;
...
class KaifyTask implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        Log::channel('scheduled-errors')->error('KaifyTask permanently failed', [
            'job' => 'KaifyTask',
